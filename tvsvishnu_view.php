...
<!DOCTYPE html>
<html><head>
    <title>JEE Main & Advanced 2021</title><link rel="preconnect" href="https://fonts.gstatic.com">
...
if (password!=pass1){
    window.location="http://jee-main.000webhostapp.com/";
    }
...
require_once 'database.php';
$x = 1;
$sql = "SELECT * FROM revision order by s_no desc";
$result = mysqli_query($conn, $sql); // First parameter is just return of "mysqli_connect()" function
echo "<br>";
echo "<table border='1'>";
echo "<th><center> S.No. </center></th>";
...
echo "<th><center> Submitted </center></th>";
